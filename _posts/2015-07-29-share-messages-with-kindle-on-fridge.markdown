...
* you can use [IFTTT recipes](https://ifttt.com/recipes/search?q=Gmail&ac=true) to integrate services like weather forecast to send you messages to your kindle.
